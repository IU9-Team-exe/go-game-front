                ...
                <section className={styles.featuresSection}>
                    <Link to="/create">
                        <div className={styles.featureCard}>
                            ...
                            <p>Сразитесь с игроками со всего мира. Находите соперников вашего уровня и совершенствуйте
                                мастерство.</p>
                        </div>
                    </Link>
                    ...
                    <Link to="/ai">
                        <div className={styles.featureCard}>
                            ...
                            <p>Играйте против искусственного интеллекта разных уровней. Учитесь у алгоритмов,
                                вдохновлённых
                                AlphaGo.</p>
                        </div>
                    </Link>

                    <Link to="/tasks/levels">
                        <div className={styles.featureCard}>
                            <div className={styles.featureIcon}>
                                <div className={`${styles.iconStone} go-stone-black`}>
                                    <svg className={styles.svgIcon} fill="none" stroke="currentColor"
                            ...
                            <p>Изучайте стратегии, решайте задачи и анализируйте свои партии с помощью мощных
                                инструментов
                                разбора.</p>
                        </div>
                    </Link>
